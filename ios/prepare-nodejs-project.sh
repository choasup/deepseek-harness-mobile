...
for p in mobile-app remote-registry shell-ssh tool-fs-search tool-camera tool-sensors remote-bootstrap client-ui-capabilities client-ui-layout-mobile client-ui-env; do
